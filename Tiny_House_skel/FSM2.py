...
d.DIO_set_output("DIO_13") # relay to short batteries to inverter
...
class State_3(State):
    ...
    def Enter(self):
        ...
        d.DIO_set_high("DIO_13") # inverter to bat
        ...
        d.DIO_set_high("DIO_07")  # sw3 closed
        #d.DIO_set_high("DIO_11")  # surge closed on inverter side
    ...
    def Exit(self):
        ...
        d.DIO_set_low("DIO_05")
        d.DIO_set_low("DIO_07")
        d.DIO_set_low("DIO_13") # inverter to bat
        d.DIO_set_low("PC104_C18")
...
class State_5(State):
    ...
    def Enter(self):
        ...
        d.DIO_set_low("DIO_11") #soft start on inverter side
